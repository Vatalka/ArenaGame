...
mixin _$BattleSelection {
 ...
 Area? get selectedAttack; Area? get selectedBlock; bool get isBotMode; int get roundNumber;
...
@useResult
$Res call({
 Area? selectedAttack, Area? selectedBlock, bool isBotMode, int roundNumber
});
...
/// Create a copy of BattleSelection
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? selectedAttack = freezed,Object? selectedBlock = freezed,Object? isBotMode = null,Object? roundNumber = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( Area? selectedAttack,  Area? selectedBlock,  bool isBotMode,  int roundNumber)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _BattleSelection() when $default != null:
return $default(_that.selectedAttack,_that.selectedBlock,_that.isBotMode,_that.roundNumber);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( Area? selectedAttack,  Area? selectedBlock,  bool isBotMode,  int roundNumber)  $default,) {final _that = this;
switch (_that) {
case _BattleSelection():
return $default(_that.selectedAttack,_that.selectedBlock,_that.isBotMode,_that.roundNumber);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( Area? selectedAttack,  Area? selectedBlock,  bool isBotMode,  int roundNumber)?  $default,) {final _that = this;
switch (_that) {
case _BattleSelection() when $default != null:
return $default(_that.selectedAttack,_that.selectedBlock,_that.isBotMode,_that.roundNumber);case _:
  return null;
...
class _BattleSelection extends BattleSelection {
  const _BattleSelection({this.selectedAttack, this.selectedBlock, this.isBotMode = false, this.roundNumber = 1}): super._();
...
/// Create a copy of BattleSelection
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? selectedAttack = freezed,Object? selectedBlock = freezed,Object? isBotMode = null,Object? roundNumber = null,}) {
